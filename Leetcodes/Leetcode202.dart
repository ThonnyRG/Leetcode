class Solution {
  ...
  void solve(int r, int c, List<List<String>> grid, List<List<bool>> vis) {
    int n = grid.length;
    int m = grid[0].length;
    ...
    List<int> dp1 = [1, -1, 0, 0];
    List<int> dp2 = [0, 0, -1, 1];
  ...
  int numIslands(List<List<String>> grid) {
    ...
    List<List<bool>> vis = List.generate(n, (i) => List.generate(m, (j) => false));
